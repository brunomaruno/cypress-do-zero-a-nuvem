describe("Central de atendimento ao Cliente TAT", () => {
  Cypress._.times(3, () => {
    ...
    it.only("Preencha os campos obrigatorios e enviar o formulario", () => {
      ...
      cy.get(".success").should("be.visible").invoke('hide').should('not.be.visible');//uso do invoke() para esconder a mensagem de sucesso

      cy.get('.error').invoke('show').should('be.visible');//uso do invoke() para exibir a mensagem de erro
